...
void runER(
    ...
    // Write prettified JSON to another file
    std::ofstream o("C:\\Users\\kuzne\\Documents\\ACTIVE_PROJECTS\\research\\experiments\\articulation_points_multiplex\\results_ER.json");
    o << std::setw(4) << output << std::endl;
...
void runERMonoplex(
    ...
    for (int i = 0; i < cNum; ++i) {
        ...
        for (int runID = 0; runID < nRuns; ++runID) {
            ...
            Graph G;
            createErdosRenyiNetwork(G, N, c, seed + seed - 1);
            ++seed;
