                                 ...
                                 const bool printMCC)
{
    ...
    printf("\n***********************************\n");
    printf("Process: Site Percolation [cost type=%s] \n", costType.c_str());
    ...
    sprintf(outputFileName1, "%s/SP_%s._SEED_%ld._%s._%s.gmcc", outputAddress.c_str(), costType.c_str(), seed, 
        network1.name.c_str(), network2.name.c_str());
    ...
    sprintf(outputFileName2, "%s/SP_%s._SEED_%ld._%s._%s.mcc",
